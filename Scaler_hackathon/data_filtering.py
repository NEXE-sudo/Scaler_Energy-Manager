...
def is_valid_action(action_dict: Optional[Dict[str, Any]], agent_type: str = "unified") -> bool:
    ...
    if agent_type == "unified":
        # For unified, require all dispatch, planning, and market keys
        required_keys = AGENT_REQUIRED_KEYS["dispatch"] | AGENT_REQUIRED_KEYS["planning"] | AGENT_REQUIRED_KEYS["market"]
    else:
        required_keys = AGENT_REQUIRED_KEYS.get(agent_type, set())

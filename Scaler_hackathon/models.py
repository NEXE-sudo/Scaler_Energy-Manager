...
class PlanningAgentAction(Action):
    ...
    It operates on a multi-step horizon (1572 steps) and is rewarded
    ...
    build times (nuclear=15 steps, hydro=10, wind/solar=68) and
...
class MarketAgentAction(Action):
    ...
    demand_response_mw: float = Field(
        ...
        description=(
            ...
            "Range: 0150 MW. Reduces effective demand immediately. "
    ...
    grid_export_mw: float = Field(
        ...
        description=(
            ...
            "Range: 0100 MW. Earns feed-in credits. "
    ...
    grid_import_mw: float = Field(
        ...
        description=(
            ...
            "Range: 0100 MW. Costs coal_price * 1.2 per MWh. "
    ...
    coal_price_bid: Optional[float] = Field(
        ...
        description=(
            ...
            "Range: 0.53.0 multiplier. Accepted probabilistically "
...
class EnergyGridAction(Action):
    ...
    demand_response_mw: float = Field(default=0.0, ge=0.0, le=150.0,
        description="Voluntary demand reduction (MW). Range: 0150.")
